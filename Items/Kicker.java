...
//inamicul cu rosu melee, asemanator cu magician
public class Kicker extends Character {
    ...
    public Kicker(RefLinks refLink, float x, float y) {
    ...
    public void Draw(Graphics g) {
        if(!inv)
        {
            if(!dead)
            {
                BufferedImage image = kicker[action][aniIndex];
